...
console.log("[DBotList.ml]: Botlist/Add Bot router loaded.");
    ...
    app.post("/addbot", global.checkAuth, async (req,res) => {
      ...
      client.channels.cache.get(channels.botlog).send(`<:blurple_plus:915978019938631680> <@${req.user.id}> added \`${a.tag}\` \n**https://dbotlist.ml/bot/${rBody['botID']}/**`)
